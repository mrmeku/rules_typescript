...
const keep = "keep" // marker in srcs or deps to tell taze to preserve.
...
// merged file.
//
// "genFile" is a file generated by Taze. It must not be nil.
...
func mergeRule(gen, old *bf.CallExpr) bf.Expr {
	...
	// leave in place.
	// TODO: maybe taze should allow the prefix to be changed.
...
// shouldIgnore checks whether "taze:ignore" appears at the beginning of
